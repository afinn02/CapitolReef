...
```
The following file is a summary of the data captured from motion sensor cameras within Capitol Reef National Park. The sightings in this report occur between `r min_date` and `r max_date`. It includes a summary from `r length(locations)` locations and `r length(cameras)` different cameras.
